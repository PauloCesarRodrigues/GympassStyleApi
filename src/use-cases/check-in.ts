...
export class CheckInUseCase {
  ...
  async execute({gymId, userId, userLatitude, userLogitude}: CheckInUseCaseRequest):Promise<CheckInUseCaseResponse>{
    ...
    const distance = getDistanceBetweenCoordinates({latitude: userLatitude, longitude: userLogitude}, {latitude: gym.latitude.toNumber(), longitude: gym.longitude.toNumber()})
